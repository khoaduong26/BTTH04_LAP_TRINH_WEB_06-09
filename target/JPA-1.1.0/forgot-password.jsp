...
<head>
    ...
    <style>
        ...
        * {
        ...
        @keyframes pulse {
            0% { box-shadow: 0 4px 10px rgba(245, 158, 11, 0.4); }
            50% { box-shadow: 0 4px 20px rgba(245, 158, 11, 0.6); }
            100% { box-shadow: 0 4px 10px rgba(245, 158, 11, 0.4); }
        }
                    ...
                    <c:when test="${step == 'reset'}">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="password" name="confirmPassword" class="form-control" placeholder="Xác nhận mật khẩu mới" minlength="6" required>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="Địa chỉ email" 
                                       ...
                                       title="Vui lòng nhập địa chỉ Gmail hợp lệ (ví dụ: example@gmail.com)" required>
                            </div>
                        </div>
