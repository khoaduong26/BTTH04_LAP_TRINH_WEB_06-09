...
<head>
    ...
    <title>Manager Dashboard - Quản Lý Categories Cá Nhân</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="welcome-card">
            ...
            <p>Quản lý các categories của riêng bạn tại đây</p>
        </div>
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-label">Categories của tôi</div>
            </div>
            <div class="stat-card">
        ...
        <div class="content-card">
            <div class="card-header">
                <h2 class="card-title">
                    <i class="fas fa-folder-open"></i> Categories Của Tôi
                </h2>
            ...
            <c:choose>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="${pageContext.request.contextPath}/manager/categories?action=edit&id=${cate.id}" 
                                               class="btn btn-warning btn-sm" title="Sửa">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="${pageContext.request.contextPath}/manager/categories?action=delete&id=${cate.id}" 
                ...
                <c:otherwise>
                    <div class="empty-state">
                        ...
                        <h3>Bạn chưa có category nào</h3>
                        <p>Hãy tạo category đầu tiên của bạn để bắt đầu quản lý.</p>
                        <a href="${pageContext.request.contextPath}/manager/categories?action=add" class="btn btn-primary">
                            <i class="fas fa-plus"></i> Tạo Category Đầu Tiên
                        </a>
                    </div>
                </c:otherwise>
            </c:choose>
